...
export default function PathParameters() {
  ...
  return (
    <div>
      ...
      <a className="btn btn-primary me-2 mb-2" id="wd-path-parameter-add"
        href={`${REMOTE_SERVER}/lab5/add/${a}/${b}`}>
        Add {a} + {b}
      </a>
      <a className="btn btn-danger me-2 mb-2" id="wd-path-parameter-subtract"
        href={`${REMOTE_SERVER}/lab5/subtract/${a}/${b}`}>
        Subtract {a} - {b}
      </a>
      <a className="btn btn-danger me-2 mb-2" id="wd-path-parameter-multiply"
        href={`${REMOTE_SERVER}/lab5/multiply/${a}/${b}`}>
        Multiply {a} * {b}
      </a>
      <a className="btn btn-danger me-2 mb-2" id="wd-path-parameter-divide"
