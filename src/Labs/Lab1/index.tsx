export default function Lab1() {
    return (
      ...
      <div id="wd-h-tag">
        ...
        Each section is usually prefaced with a short title or heading that attempts to summarize the topic 
        of the section it precedes. For instance this paragraph is preceded by the heading Heading Tags. 
      ...
      <div id="wd-lists">
        ...
        <div id="wd-lists">
          ...
          <h5>MY FAVORITE GO-TO RECIPE- MASALA MAGGI</h5>
          How to make masala maggi:
          <ol id="wd-maggi"></ol>
            <li>Boil water in a vessel.</li>
            <li>Add maggi noodles to it.</li>
            <li>Add masala packet to the vessel.</li>
            <li>Add extra spices to it according to your taste.</li>
            <li>Cut green chillies and put in the pan</li>
            <li>Let the noodles come to a boil.</li>
            <li>Take the noodles out in a bowl.</li>
            <li>Grate cheese on top of the noodles and enjoy!</li>
        </div>
